<template>
	<section id="contact" class="grid w-11/12 sm:w-6/12 xl:w-full m-auto h-max sm:h-screen py-40">
		<div class="flex flex-col gap-4 2xl:gap-8 items-center mt-20 sm:mt-0">
			...
			<form ref="form" id="contactForm" @submit="sendMail" class="flex flex-col items-center w-full sm:w-6/12 sm:grid grid-cols-2 gap-4 2xl:gap-8">
				<input class="text-grey w-full pl-2 sm:pl-4 h-12 sm:h-16 bg-transparent border border-primary-light text-base xl:text-xl 2xl:text-2xl 4xl:text-4xl" placeholder="Name" type="text" name="user_name" id="name" required>
				<input class="text-grey w-full pl-2 sm:pl-4 h-12 sm:h-16 bg-transparent border border-primary-light text-base xl:text-xl 2xl:text-2xl 4xl:text-4xl" placeholder="E-mail" type="text" name="user_email" id="email" required>
