<template>
	<section id="contact" class="grid w-11/12 sm:w-6/12 xl:w-full m-auto h-max pb-8">
		<div class="flex flex-col gap-4 2xl:gap-8 items-center mt-20 sm:mt-40 2xl:mt-80 4xl:mt-96">
			...
			<form ref="form" enctype="text/plain" id="contactForm" class="flex flex-col items-center sm:w-6/12 sm:grid grid-cols-2 gap-4 2xl:gap-8">
				...
				<input @click="sendMail" class="justify-self-center col-span-2 bg-transparent text-primary-light p-3 pl-16 pr-16 w-max border-2 border-primary-light" type="submit" name="submit" value="submit">
			</form>
		</div>
