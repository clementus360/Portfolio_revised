<template>
	<div class="flex flex-col justify-self-center justify-items-center sm:flex-row items-center">
		<a :href="details.link" target="_blank"><div class="z-20 relative hover:scale-95 transition-all cursor-pointer flex sm:left-7 w-[100vw] overflow-hidden sm:overflow-visible sm:w-max h-72 justify-center items-center 2xl:top-24">
